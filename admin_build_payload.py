        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="md:col-span-1 bg-white p-6 rounded-lg shadow-md">
                ...
                <form id="item-form" class="space-y-4">
                    ...
                    <div><label class="block text-sm font-medium text-gray-700">Item Name</label><input type="text" id="item-name" class="mt-1 block w-full p-2 border border-gray-300 rounded-md"></div>
                    <div><label class="block text-sm font-medium text-gray-700">Quantity</label><input type="number" id="item-quantity" class="mt-1 block w-full p-2 border border-gray-300 rounded-md"></div>
                    <div><label class="block text-sm font-medium text-gray-700">Price (PHP)</label><input type="number" id="item-price" step="0.01" class="mt-1 block w-full p-2 border border-gray-300 rounded-md"></div>
            ...
            <div class="md:col-span-2 bg-white p-6 rounded-lg shadow-md">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        <thead class="border-b-2"><tr><th class="p-2">ID</th><th class="p-2">Name</th><th class="p-2">Stock</th><th class="p-2">Price</th></tr></thead>
